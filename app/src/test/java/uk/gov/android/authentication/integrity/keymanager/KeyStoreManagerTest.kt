    ...
    fun `convert signature from DER format to ASN1 format`() {
        val spec = ECParameterSpec(
            EllipticCurve(
                ...
                BigInteger("11579208921035624876269744694940757353008614341529031419553" +
                        "3631308867097853948"),
                BigInteger("41058363725152142129326129780047268409114441015993725554" +
                        "835256314039467401291")
            ),
            ECPoint(
                BigInteger("4843956129390645175905258525279791420276294952604174799584" +
                        "4080717082404635286"),
                BigInteger("3613425095674979579858512791958788195661110667298501507187" +
                        "7198253568414405109")
            ),
            BigInteger("11579208921035624876269744694940757352999695522413576034242225" +
                    "9061068512044369"),
            1
        )
        val input = byteArrayOf(48, 69, 2, 33, 0, -35, 79, -118, -2, -67, -74, 19, 59, 93, -39, -84,
        ...
        val expected = byteArrayOf(-35, 79, -118, -2, -67, -74, 19, 59, 93, -39, -84, 57, 11, -38,
